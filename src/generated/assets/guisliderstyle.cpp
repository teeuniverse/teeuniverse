...
void CAsset_GuiSliderStyle::CTuaType::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType& TuaType, CAsset_GuiSliderStyle& SysType)
{
...
void CAsset_GuiSliderStyle::CTuaType::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_GuiSliderStyle& SysType, CTuaType& TuaType)
{
...
int CAsset_GuiSliderStyle::DeleteSubItem(const CSubPath& SubPath)
{
}
