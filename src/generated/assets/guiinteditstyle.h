...
public:
	...
	public:
		CAssetPath::CTuaType m_IncreaseButtonStylePath;
		CAssetPath::CTuaType m_DecreaseButtonStylePath;
		static void Read(class CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_2_1& TuaType, CAsset_GuiIntEditStyle& SysType);
		static void Write(class CAssetsSaveLoadContext* pLoadingContext, const CAsset_GuiIntEditStyle& SysType, CTuaType_0_2_1& TuaType);
	};
	...
	public:
		CAssetPath::CTuaType m_IncreaseButtonStylePath;
		CAssetPath::CTuaType m_DecreaseButtonStylePath;
		static void Read(class CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_2_2& TuaType, CAsset_GuiIntEditStyle& SysType);
	...
	public:
		CAssetPath::CTuaType m_IncreaseButtonStylePath;
		CAssetPath::CTuaType m_DecreaseButtonStylePath;
		static void Read(class CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_2_4& TuaType, CAsset_GuiIntEditStyle& SysType);
		static void Write(class CAssetsSaveLoadContext* pLoadingContext, const CAsset_GuiIntEditStyle& SysType, CTuaType_0_2_4& TuaType);
	};
