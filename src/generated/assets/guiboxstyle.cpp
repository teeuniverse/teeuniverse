...
void CAsset_GuiBoxStyle::CTuaType_0_2_0::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_GuiBoxStyle& SysType, CTuaType_0_2_0& TuaType)
{
...
void CAsset_GuiBoxStyle::CTuaType_0_2_1::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_2_1& TuaType, CAsset_GuiBoxStyle& SysType)
{
...
void CAsset_GuiBoxStyle::CTuaType_0_2_1::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_GuiBoxStyle& SysType, CTuaType_0_2_1& TuaType)
{
...
void CAsset_GuiBoxStyle::CTuaType_0_2_2::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_2_2& TuaType, CAsset_GuiBoxStyle& SysType)
{
...
void CAsset_GuiBoxStyle::CTuaType_0_2_2::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_GuiBoxStyle& SysType, CTuaType_0_2_2& TuaType)
{
...
void CAsset_GuiBoxStyle::CTuaType_0_2_3::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_2_3& TuaType, CAsset_GuiBoxStyle& SysType)
{
...
void CAsset_GuiBoxStyle::CTuaType_0_2_3::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_GuiBoxStyle& SysType, CTuaType_0_2_3& TuaType)
{
...
void CAsset_GuiBoxStyle::CTuaType_0_2_4::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_2_4& TuaType, CAsset_GuiBoxStyle& SysType)
{
...
int CAsset_GuiBoxStyle::AddSubItemAt(int Type, const CSubPath& SubPath, int Index)
{
	return -1;
}
