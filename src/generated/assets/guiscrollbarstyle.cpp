...
void CAsset_GuiScrollbarStyle::CTuaType_0_1_0::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_1_0& TuaType, CAsset_GuiScrollbarStyle& SysType)
{
...
void CAsset_GuiScrollbarStyle::CTuaType_0_1_0::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_GuiScrollbarStyle& SysType, CTuaType_0_1_0& TuaType)
{
...
void CAsset_GuiScrollbarStyle::CTuaType_0_2_0::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_2_0& TuaType, CAsset_GuiScrollbarStyle& SysType)
{
...
void CAsset_GuiScrollbarStyle::CTuaType_0_2_0::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_GuiScrollbarStyle& SysType, CTuaType_0_2_0& TuaType)
{
...
void CAsset_GuiScrollbarStyle::CTuaType_0_2_2::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_2_2& TuaType, CAsset_GuiScrollbarStyle& SysType)
{
...
void CAsset_GuiScrollbarStyle::CTuaType_0_2_2::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_GuiScrollbarStyle& SysType, CTuaType_0_2_2& TuaType)
{
...
void CAsset_GuiScrollbarStyle::CTuaType_0_2_3::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_2_3& TuaType, CAsset_GuiScrollbarStyle& SysType)
{
...
void CAsset_GuiScrollbarStyle::CTuaType_0_2_3::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_GuiScrollbarStyle& SysType, CTuaType_0_2_3& TuaType)
{
...
void CAsset_GuiScrollbarStyle::CTuaType_0_2_4::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_2_4& TuaType, CAsset_GuiScrollbarStyle& SysType)
{
...
void CAsset_GuiScrollbarStyle::CTuaType_0_2_4::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_GuiScrollbarStyle& SysType, CTuaType_0_2_4& TuaType)
{
...
template<>
bool CAsset_GuiScrollbarStyle::SetValue(int ValueType, const CSubPath& SubPath, int Value)
{
	switch(ValueType)
	{
		case MARGIN:
...
template<>
CAssetPath CAsset_GuiScrollbarStyle::GetValue(int ValueType, const CSubPath& SubPath, CAssetPath DefaultValue) const
{
	switch(ValueType)
	{
		case RECTPATH:
		...
		case DEFAULTSLIDERPATH:
			return GetDefaultSliderPath();
		case MOUSEOVERSLIDERPATH:
			return GetMouseOverSliderPath();
	}
	return CAsset::GetValue<CAssetPath>(ValueType, SubPath, DefaultValue);
}

template<>
bool CAsset_GuiScrollbarStyle::SetValue(int ValueType, const CSubPath& SubPath, CAssetPath Value)
{
	switch(ValueType)
	{
		case RECTPATH:
		...
		case DEFAULTRAILPATH:
			...
			return true;
		case DEFAULTSLIDERPATH:
			SetDefaultSliderPath(Value);
			return true;
		case MOUSEOVERSLIDERPATH:
			SetMouseOverSliderPath(Value);
			return true;
	}
