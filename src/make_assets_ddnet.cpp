...
int main(int argc, char* argv[])
{
	...
	CAssetPath ImageSwitchPath = CreateNewImage(pKernel, PackageId, "zones_switch", "images/univ_ddnet/zones_switch.png", CStorage::TYPE_ALL, 16, 16, true, 0);
	CAssetPath ImageTelePath = CreateNewImage(pKernel, PackageId, "zones_teleport", "images/univ_ddnet/zones_teleport.png", CStorage::TYPE_ALL, 16, 16, true, 0);
