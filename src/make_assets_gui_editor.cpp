...
int main(int argc, const char **argv)
{
	...
	//Images
	CAssetPath ImageEditorPath = CreateNewImage(pKernel, PackageId, "editor", "datasrc/images/gui_editor.png", CStorage::TYPE_ALL, 64, 32);
	...
	CREATE_SPRITE(PackageId, "iconFill", ImageEditorPath, 27*2, 0*2, 2, 2);
	...
	CREATE_SPRITE(PackageId, "gizmoVertexBg", ImageEditorPath, 0*2, 11*2, 2, 2);
	CREATE_SPRITE(PackageId, "gizmoVertexFg", ImageEditorPath, 1*2, 11*2, 2, 2);
