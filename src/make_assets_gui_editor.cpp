...
{
	{
		...
		//Images
		CAssetPath ImageEditorPath = CreateNewImage(pKernel.get(), PackageId, "editor", "images/gui_editor.png", CStorage::TYPE_ALL, 64, 32);
		CAssetPath ImageBoxesPath = CreateNewImage(pKernel.get(), PackageId, "boxes", "images/gui_editor_box.png", CStorage::TYPE_ALL, 16, 16);
		CreateNewImage(pKernel.get(), PackageId, "checker", "images/gui_editor_checker.png", CStorage::TYPE_ALL, 16, 16);
		...
		CREATE_SPRITE(PackageId, "iconZoomUnit", ImageEditorPath, 40, 20, 3, 3);
